...
/// <summary>
/// Result model for sales reports
/// </summary>
public class GetSalesReportResult
{
    ...
    /// </summary>
    public List<SalesGroupResult> Groups { get; set; } = new();
    ...
    /// </summary>
    public List<TopCustomerResult> TopCustomers { get; set; } = new();
}

/// <summary>
/// Represents a group of sales data
/// </summary>
public class SalesGroupResult
{
    /// <summary>

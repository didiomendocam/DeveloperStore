...
{
    [Fact]
    public void UpdateCustomerDto_WithValidData_ShouldPassValidation()
    {
        // Arrange
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void UpdateCustomerDto_WithInvalidName_ShouldFailValidation(string invalidName)
    {
        // Arrange
        var dto = new UpdateCustomerDto
        {
    ...
    public void UpdateCustomerDto_WithInvalidDocument_ShouldFailValidation(string invalidDocument)
    {
        // Arrange
        var dto = new UpdateCustomerDto
        {
    ...
    public void UpdateCustomerDto_WithInvalidContact_ShouldFailValidation(string invalidContact)
    {
        // Arrange
        var dto = new UpdateCustomerDto
        {
    ...
    public void UpdateCustomerDto_WithValidDocument_ShouldPassValidation(string validDocument)
    {
        // Arrange
        var dto = new UpdateCustomerDto
        {
    ...
    public void UpdateCustomerDto_WithValidContact_ShouldPassValidation(string validContact)
    {
        // Arrange
        var dto = new UpdateCustomerDto
        {

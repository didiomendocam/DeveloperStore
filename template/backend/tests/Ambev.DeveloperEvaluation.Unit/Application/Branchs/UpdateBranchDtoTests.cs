...
public class UpdateBranchDtoTests
{
    [Fact]
    public void UpdateBranchDto_WithValidData_ShouldPassValidation()
    {
        // Arrange
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void UpdateBranchDto_WithInvalidName_ShouldFailValidation(string invalidName)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    public void UpdateBranchDto_WithInvalidCnpj_ShouldFailValidation(string invalidCnpj)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void UpdateBranchDto_WithInvalidAddress_ShouldFailValidation(string invalidAddress)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    public void UpdateBranchDto_WithInvalidPhone_ShouldFailValidation(string invalidPhone)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    public void UpdateBranchDto_WithInvalidEmail_ShouldFailValidation(string invalidEmail)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    public void UpdateBranchDto_WithValidCnpj_ShouldPassValidation(string validCnpj)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    public void UpdateBranchDto_WithValidPhone_ShouldPassValidation(string validPhone)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
    ...
    public void UpdateBranchDto_WithValidEmail_ShouldPassValidation(string validEmail)
    {
        // Arrange
        var dto = new UpdateBranchDto
        {
